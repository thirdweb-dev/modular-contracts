...
import {IERC20Hook} from "@core-contracts/interface/hook/IERC20Hook.sol";

import {ERC20Core, HookInstaller} from "@core-contracts/core/token/ERC20Core.sol";
import {AllowlistMintHookERC20, ERC20Hook} from "src/token/mint/AllowlistMintHookERC20.sol";
...
contract AllowlistMintHookERC20Test is Test {
    ...
    function test_setDefaultFeeConfig_state() public {
        ...
        vm.prank(developer);
        address(erc20Core).call(abi.encodeWithSelector(AllowlistMintHookERC20.setDefaultFeeConfig.selector, feeConfig));
