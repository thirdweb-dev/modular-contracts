...
import {ERC1155Core, HookInstaller} from "@core-contracts/core/token/ERC1155Core.sol";
import {MintHookERC1155, ERC1155Hook} from "src/token/mint/MintHookERC1155.sol";

import {IMintRequest} from "@core-contracts/interface/common/IMintRequest.sol";
import {IClaimCondition} from "src/interface/IClaimCondition.sol";
import {IFeeConfig} from "src/interface/IFeeConfig.sol";
...
contract MintHookERC1155Test is Test {
    ...
    function test_setDefaultFeeConfig_state() public {
        ...
        vm.prank(developer);
        address(erc1155Core).call(abi.encodeWithSelector(MintHookERC1155.setDefaultFeeConfig.selector, feeConfig));
