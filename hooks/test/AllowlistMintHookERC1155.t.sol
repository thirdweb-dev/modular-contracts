...
import {IERC1155Hook} from "@core-contracts/interface/hook/IERC1155Hook.sol";

import {ERC1155Core, HookInstaller} from "@core-contracts/core/token/ERC1155Core.sol";
import {AllowlistMintHookERC1155, ERC1155Hook} from "src/token/mint/AllowlistMintHookERC1155.sol";
...
contract AllowlistMintHookERC1155Test is Test {
    ...
    function test_setClaimCondition_state_updateCurrentCondition() public {
        ...
        vm.prank(endUser);
        erc1155Core.mint{value: condition.price}(mintRequest);
    ...
    function test_setDefaultFeeConfig_state() public {
        ...
        vm.prank(endUser);
        erc1155Core.mint{value: 1 ether}(mintRequest);
    ...
    function test_beforeMint_state() public {
        ...
        vm.prank(endUser);
        erc1155Core.mint{value: condition.price * 5}(mintRequest);
    ...
    function test_beforeMint_revert_notEnoughSupply() public {
        ...
        erc1155Core.mint{value: condition.price * 11}(mintRequest);

        mintRequest.quantity = 0;

        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(AllowlistMintHookERC1155.AllowlistMintHookInvalidQuantity.selector));
        erc1155Core.mint{value: 0}(mintRequest);
    }
    ...
    function test_beforeMint_revert_incorrectValueSent() public {
        ...
        erc1155Core.mint{value: condition.price - 1}(mintRequest);
    }
}
