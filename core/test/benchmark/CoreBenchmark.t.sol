...
contract MockBase {
    ...
    function getFunctionSignature() internal pure returns (bytes4[] memory functions) {
...
contract CoreBenchmark is Test {
    ...
    function test_installExtension() public {
        core.installExtension(address(extension), 0, "");
    }
    ...
    function test_uninstallExtension() public {
        ...
        core.uninstallExtension(address(extension), 0, "");
    }
}
