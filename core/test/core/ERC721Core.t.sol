...
contract ERC721CoreTest is Test, TestPlus {
    ...
    function setUp() public {
        ...
        hookProxyAddress = address(
            new EIP1967Proxy(address(new MockExtensionERC721()), hookInitData)
        );
    ...
    function testBurn() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IERC721A.OwnerQueryForNonexistentToken.selector
            )
        );
    ...
    function testApproveBurn() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IERC721A.ApprovalQueryForNonexistentToken.selector
            )
        );
    ...
    function test_revert_MintToZero() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IERC721A.MintToZeroAddress.selector)
        );
        token.mint(minter, quantity, "");
    }
    ...
    function test_revert_ApproveUnAuthorized() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IERC721A.ApprovalCallerNotOwnerNorApproved.selector
            )
        );
    ...
    function test_revert_TransferFromWrongFrom() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IERC721A.TransferFromIncorrectOwner.selector)
        );
    ...
    function test_revert_TransferFromToZero() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IERC721A.TransferToZeroAddress.selector)
        );
        ...
        public
    {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IERC721A.TransferToNonERC721ReceiverImplementer.selector
            )
        );
    ...
    function test_revert_BalanceOfZeroAddress() public {
        vm.expectRevert(
            abi.encodeWithSelector(IERC721A.BalanceQueryForZeroAddress.selector)
        );
