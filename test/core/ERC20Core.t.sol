...
contract ERC20CoreTest is Test, TestPlus {
    ...
    function testTransferInsufficientBalanceReverts() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20Initializable.ERC20TransferAmountExceedsBalance.selector, 1e18, 0.9e18)
        );
    ...
    function testTransferFromInsufficientAllowanceReverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ERC20Initializable.ERC20InsufficientAllowance.selector, 0.9e18, 1e18));
    ...
    function testBurnInsufficientBalanceReverts(address to, uint256 mintAmount, uint256 burnAmount) public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ERC20Initializable.ERC20TransferAmountExceedsBalance.selector, burnAmount, mintAmount
            )
        );
        vm.prank(to);
        token.burn(burnAmount, "");
    ...
    function testTransferInsufficientBalanceReverts(address to, uint256 mintAmount, uint256 sendAmount) public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ERC20Initializable.ERC20TransferAmountExceedsBalance.selector, sendAmount, mintAmount
            )
        );
    ...
    function testTransferFromInsufficientAllowanceReverts(address to, uint256 approval, uint256 amount) public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20Initializable.ERC20InsufficientAllowance.selector, approval, amount)
        );
    ...
    function testPermitBadNonceReverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ERC20Core.ERC20PermitInvalidSigner.selector));
    ...
    function testPermitPastDeadlineReverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ERC20Core.ERC20PermitDeadlineExpired.selector));
        token.permit(t.owner, t.to, t.amount, t.deadline, t.v, t.r, t.s);
    }
