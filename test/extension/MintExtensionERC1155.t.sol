...
contract MintExtensionERC1155Test is Test {
    ...
    function setUp() public {
        ...
        address mintExtensionImpl = address(new MintExtensionERC1155());

        bytes memory initData = abi.encodeWithSelector(
            MintExtensionERC1155.initialize.selector,
            platformAdmin // upgradeAdmin
        );
        address mintExtensionProxy = address(new EIP1967Proxy(mintExtensionImpl, initData));
        mintExtension = MintExtensionERC1155(mintExtensionProxy);
        ...
        // Developer deploys proxy for ERC1155 core with MintExtensionERC1155 preinstalled.
    ...
    function test_setClaimCondition_state_only() public {
        ...
        erc1155Core.hookFunctionWrite(BEFORE_MINT_FLAG, 0, abi.encodeWithSelector(MintExtensionERC1155.setClaimCondition.selector, 0, condition, false));
    ...
    function test_setClaimCondition_state_newConditionResetEligibility() public {
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(BEFORE_MINT_FLAG, 0, abi.encodeWithSelector(MintExtensionERC1155.setClaimCondition.selector, 0, condition, true));
        ...
        assertEq(mintExtension.getClaimCondition(address(erc1155Core), 0).metadata, newCondition.metadata);
    }
    ...
    function test_setClaimCondition_state_updateCurrentCondition() public {
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(BEFORE_MINT_FLAG, 0, abi.encodeWithSelector(MintExtensionERC1155.setClaimCondition.selector, 0, newCondition, false));
    ...
    function test_setDefaultFeeConfig_state() public {
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(BEFORE_MINT_FLAG, 0, abi.encodeWithSelector(MintExtensionERC1155.setDefaultFeeConfig.selector, feeConfig));
    ...
    function test_setFeeConfigForToken_state() public {
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(BEFORE_MINT_FLAG, 0, abi.encodeWithSelector(MintExtensionERC1155.setFeeConfigForToken.selector, 0, specialFeeConfig));
    ...
    function test_beforeMint_revert_erc20Price_sentMsgValue() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(MintExtensionERC1155.MintExtensionInvalidPrice.selector, 0, 1 wei));
    ...
    function test_beforeMint_revert_permissionlessMint_callerNotMintRequestToken() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(MintExtensionERC1155.MintExtensionNotToken.selector));
    ...
    function test_beforeMint_revert_permissionlessMint_minterNotMintRequestMinter() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(MintExtensionERC1155.MintExtensionInvalidRecipient.selector));
        erc1155Core.mint{value: req.pricePerToken * req.quantity}(endUser, 0, req.quantity, abi.encode(req));
    }
