...
contract RoyaltyERC721Test is Test {
    ...
    function setUp() public {
        vm.createSelectFork(vm.envString("ETH_RPC_URL"), 20585576);
    ...
    function test_setTransferValidatorPolicies() public {
        ...
        address[] memory whitelistedAccounts = transferValidator
            .getWhitelistedAccountsByCollection(address(core));
