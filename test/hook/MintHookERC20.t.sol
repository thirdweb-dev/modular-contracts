...
contract MintHookERC20Test is Test {
    ...
    function test_setClaimCondition_state_only() public {
        ...
        mintHook.setClaimCondition(address(erc20Core), condition, false);
    ...
    function test_setClaimCondition_state_newConditionResetEligibility() public {
        ...
        vm.prank(developer);
        mintHook.setClaimCondition(address(erc20Core), condition, true);
    ...
    function test_setClaimCondition_revert_notAdminOfToken() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(MintHookERC20.MintHookNotAuthorized.selector));
        mintHook.setClaimCondition(address(erc20Core), condition, false);
    }
    ...
    function test_beforeMint_revert_nativeTokenPrice_msgValueNotEqPrice() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(MintHookERC20.MintHookInvalidPrice.selector, (condition.pricePerToken * req.quantity) / 1 ether, (condition.pricePerToken * req.quantity - 1) / 1 ether));
    ...
    function test_beforeMint_revert_permissionlessMint_invalidCurrency() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(MintHookERC20.MintHookInvalidCurrency.selector, condition.currency, req.currency));
        erc20Core.mint(req.minter, req.quantity, abi.encode(req));
    }
    ...
    function test_beforeMint_revert_permissionlessMint_invalidPrice() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(abi.encodeWithSelector(MintHookERC20.MintHookInvalidPrice.selector, condition.pricePerToken, req.pricePerToken));
        erc20Core.mint{value: req.pricePerToken * req.quantity / 1 ether}(req.minter, req.quantity, abi.encode(req));
    }
