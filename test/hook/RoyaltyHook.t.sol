...
contract RoyaltyHookTest is Test {
    ...
    function test_defaultRoyalty_state() public {
        ...
        vm.prank(developer);
        royaltyHook.setDefaultRoyaltyInfo(address(erc721Core), recipient, bps);
    ...
    function test_defaultRoyalty_revert_notAdminOfToken() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(RoyaltyHook.RoyaltyHookNotAuthorized.selector));
        royaltyHook.setDefaultRoyaltyInfo(address(erc721Core), recipient, bps);
    }
    ...
    function test_royaltyForToken_state() public {
        ...
        vm.prank(developer);
        royaltyHook.setRoyaltyInfoForToken(address(erc721Core), tokenId, overrideRecipient, overrideBps);
