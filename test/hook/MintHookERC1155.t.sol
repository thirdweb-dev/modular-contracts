...
contract MintHookERC1155Test is Test {
    ...
    function test_setClaimCondition_state_only() public {
        ...
        erc1155Core.hookFunctionWrite(
            BEFORE_MINT_FLAG, abi.encodeWithSelector(MintHookERC1155.setClaimCondition.selector, 0, condition, false)
        );
    ...
    function test_setClaimCondition_state_newConditionResetEligibility() public {
        ...
        vm.prank(endUser);
        erc1155Core.mint{value: condition.pricePerToken * req.quantity}(req);
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(
            BEFORE_MINT_FLAG, abi.encodeWithSelector(MintHookERC1155.setClaimCondition.selector, 0, condition, true)
        );
    ...
    function test_setClaimCondition_state_updateCurrentCondition() public {
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(
            BEFORE_MINT_FLAG, abi.encodeWithSelector(MintHookERC1155.setClaimCondition.selector, 0, newCondition, false)
        );
    ...
    function test_setDefaultFeeConfig_state() public {
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(
            BEFORE_MINT_FLAG, abi.encodeWithSelector(MintHookERC1155.setDefaultFeeConfig.selector, feeConfig)
        );
        ...
        vm.prank(endUser);
        erc1155Core.mint{value: 1 ether}(req);
    ...
    function test_setFeeConfigForToken_state() public {
        ...
        vm.prank(developer);
        erc1155Core.hookFunctionWrite(
            BEFORE_MINT_FLAG, abi.encodeWithSelector(MintHookERC1155.setFeeConfigForToken.selector, 0, specialFeeConfig)
        );
        ...
        vm.prank(endUser);
        erc1155Core.mint{value: 1 ether}(req2);
    ...
    function test_beforeMint_revert_nativeTokenPrice_msgValueNotEqPrice() public {
        ...
        erc1155Core.mint{value: condition.pricePerToken * req.quantity - 1}(req);
    }
    ...
    function test_beforeMint_revert_erc20Price_sentMsgValue() public {
        ...
        erc1155Core.mint{value: 1 wei}(req);
    }
    ...
    function test_beforeMint_state_permissionlessMint_nativeTokenPrice() public {
        ...
        vm.prank(endUser);
        erc1155Core.mint{value: req.pricePerToken * req.quantity}(req);
    ...
    function test_beforeMint_revert_permissionlessMint_invalidCurrency() public {
        ...
        vm.prank(endUser);
        vm.expectRevert(
            abi.encodeWithSelector(MintHookERC1155.MintHookInvalidCurrency.selector, condition.currency, req.currency)
        );
        erc1155Core.mint(req);
    }
