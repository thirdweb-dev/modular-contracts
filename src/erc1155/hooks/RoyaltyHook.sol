...
contract RoyaltyHook is ERC1155Hook {
  ...
  mapping(address => mapping(uint256 => RoyaltyInfo))
    private _royaltyInfoForToken;
  ...
  function _setupDefaultRoyaltyInfo(
    ...
    _defaultRoyaltyInfo[_token] = RoyaltyInfo({
  ...
  function _setupRoyaltyInfoForToken(
    ...
    _royaltyInfoForToken[_token][_tokenId] = RoyaltyInfo({
