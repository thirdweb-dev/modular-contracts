...
library LibClone {
  ...
  function initCode(
    ...
    assembly {
      ...
      mstore(
        add(result, 0x40),
        0x5af43d3d93803e602a57fd5bf30000000000000000000000
      )
  ...
  function createDeterministicERC1967(
    ...
    assembly {
      ...
      for {
        ...
        if iszero(
          call(gas(), instance, value, codesize(), 0x00, codesize(), 0x00)
        ) {
  ...
  function checkStartsWith(bytes32 salt, address by) internal pure {
    ...
    assembly {
      ...
      if iszero(
        or(iszero(shr(96, salt)), eq(shr(96, shl(96, by)), shr(96, salt)))
      ) {
