...
contract DropMintHook is IClaimCondition, IFeeConfig, ERC20Hook {
  /*//////////////////////////////////////////////////////////////
                               CONSTANTS
    //////////////////////////////////////////////////////////////*/
  ...
  mapping(bytes32 => mapping(bytes32 => uint256))
    private _supplyClaimedByWallet;
  ...
  /**
   *  @notice Checks a request to claim tokens against the active claim condition's criteria.
  ...
  function getSupplyClaimedByWallet(
    ...
    return
      _supplyClaimedByWallet[_conditionId[_token]][
        keccak256(abi.encode(_claimer, _token))
      ];
  }
  ...
  function beforeMint(
    ...
    mintParams.totalPrice = (_quantity * pricePerToken) / 1 ether;

    _claimCondition[token].supplyClaimed += _quantity;
    _supplyClaimedByWallet[_conditionId[token]][
      keccak256(abi.encode(_claimer, token))
    ] += _quantity;

    _collectPrice(_claimer, mintParams.totalPrice, currency);
  }
